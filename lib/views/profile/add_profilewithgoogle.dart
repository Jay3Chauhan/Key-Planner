...
class ProfileScreenGoogle extends StatefulWidget {
  @override
  _ProfileScreenGoogleState createState() => _ProfileScreenGoogleState();
}

class _ProfileScreenGoogleState extends State<ProfileScreenGoogle> {
  ...
  void fetchUserData() async {
    ...
    if (currentUser != null) {
      ...
      // Get the 'image' field from the document
      setState(() {
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                // CircleAvatar(
                //   radius: 56,
                //   backgroundColor: const Color.fromARGB(255, 136, 62, 62),
                //   backgroundImage:
